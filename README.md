...
- 🌧 Variables consultadas: Temperatura · Humedad relativa · Precipitación · Viento · Racha · Dirección del viento
...
1. Clona el repositorio
   ```bash
   git clone https://github.com/TUUSUARIO/dashboard-rdcft.git
   ```
